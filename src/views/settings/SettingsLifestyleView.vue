<template>
    <div class="sub-page">
        ...
        <div class="settings-nav">
            ...
            <span class="settings-title">生活方式</span>
            <div style="width:36px;"></div>
        </div>

        <div class="sub-content">
            <div class="section-label-sm" style="margin-top:12px;">生活感知</div>
            <div class="settings-group">
                <div class="settings-group-item action-item" @click="$router.push('/settings/life-aware')">
                    ...
                    <div class="sgi-label-wrap">
                        <div class="sgi-label">生活感知</div>
                        <div class="sgi-desc">通过快捷指令让 char 感知你的生活状态</div>
                    </div>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        class="sgi-arrow">
